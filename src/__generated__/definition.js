...
export const definition = {
  models: {
    Attestation: {
      interface: true,
      implements: [],
      id: "kjzl6hvfrbw6c5p37oshij68a6iz5wwdxlmcxpn091hewvxqerl5vmddqx8nspv",
      accountRelation: { type: "none" },
    },
    AccountAttestation: {
      interface: false,
      implements: [
        "kjzl6hvfrbw6c5p37oshij68a6iz5wwdxlmcxpn091hewvxqerl5vmddqx8nspv",
      ],
      id: "kjzl6hvfrbw6c8f7ggm3n4e6yzejscqoowb5j7w6ynqfrp9w1haxw423t9mbvzl",
  ...
  objects: {
    ...
    AccountAttestation: {
      ...
      uid: { type: "string", required: true },
      data: { type: "string", required: true },
      time: { type: "integer", required: true, indexed: true },
      types: {
        type: "list",
        required: false,
        item: {
  ...
  accountData: {
    ...
    accountAttestationList: { type: "connection", name: "AccountAttestation" },
  },
};
