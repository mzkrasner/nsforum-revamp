...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      ></div>
      <div className="container fixed left-0 top-20 z-10 mr-0 flex h-fit min-h-[calc(100vh_-_80px)] w-60 flex-col justify-end bg-white pb-10 pr-5 text-sm sm:sticky sm:top-10 sm:min-h-[unset] md:justify-start md:pb-0">
        <div className="py-2">
