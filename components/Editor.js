                ...
                <>
                  ...
                  {hasAccess ? (
                    <>
                      ...
                      <TextareaAutosize
                        ref={textareaRef}
                        className="min-height-200 h-full w-full resize-none rounded-b-md border border-gray-300 p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500"
...
const ToolbarButton = ({ label, onClick, isImage, loading }) => {
  if (isImage == true) {
    return (
      <>
        {loading ? (
          <div className="btn btn-primary rounded-md px-2 py-1 font-medium hover:bg-gray-50">
            <LoadingCircle />
          </div>
        ) : (
          <>
            ...
            <label
              ...
              className="btn btn-primary rounded-md px-2 py-1 font-medium hover:bg-gray-50"
              title="Add Image"
            >
              {label}
            </label>
    ...
    return (
      <button
        className="btn btn-primary rounded-md px-2 py-1 font-medium hover:bg-gray-100"
        onClick={onClick}
      >
        {label}
      </button>
