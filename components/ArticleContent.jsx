...
import { BinIcon, EditIcon, LoadingCircle } from "./Icons";
...
const ArticleContent = ({ postId, post: initialPost }, ref) => {
  ...
  const { deletePostMutation } = singlePost;
  ...
  return (
    <>
      {deleteModalOpen && (
        <Modal ref={deleteModalRef} handleClose={() => closeDeleteModal()}>
          ...
          <div className="mt-3 flex justify-end">
            <button
              className="btn-sm text-primary bg-red-500 py-1.5"
      ...
      <article ref={ref} className="mb-8 w-full overflow-x-hidden">
        {/* Post header */}
        <header>
          <div className="items-top flex flex-row justify-between">
            <h1 className="text-primary valverde mb-4 text-6xl">
              {post.content.title}
            </h1>
          ...
          <div className="mb-4 mt-4 flex items-center justify-between">
            <div className="text-secondary flex flex-row flex-wrap items-center text-xs">
              ...
              {user && user.did == post.creator && (
                <>
                  ...
                  <span className="text-secondary ml-2 mr-2">·</span>
                  <button
                    className="btn-sm bg-red-500 py-1.5"
        ...
        {/* Post content */}
        <div className="tiptap space-y-8 text-slate-500">{reactComponent}</div>
