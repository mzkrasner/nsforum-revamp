...
function Sidebar() {
	return (
		<aside className="sticky top-0 left-0 min-h-screen overflow-y-auto scrollbar-hide md:w-64 md:shrink-0 pt-6 pb-12 md:pb-20 border-l-0 md:border-l border-primary">
...
const RecentDiscussions = () => {
	...
	return (
		<div>
			<div className="text-xs uppercase text-tertiary font-semibold mb-4">
				Voting
			</div>
...
const Categories = () => {
	...
	return (
		<div>
			<div className="text-xs uppercase text-slate-600 font-semibold mb-4 mt-3">
				Active Categories
			</div>
			{loading ? (
									...
									<li className="flex flex-row" key={key}>
										...
										<div className="flex flex-1 flex-wrap items-center justify-between w-full">
											<div className="flex items-center mr-2">
												<Link
													className="truncate text-sm text-primary font-semibold hover:underline"
													href="#0"
												>
				...
				<div className="w-full">
					...
					<form className="relative flex items-center max-w-xs mx-auto">
						<input
							id="newsletter"
							type="email"
							className="bg-white placeholder:text-slate-500 text-slate-900 border border-slate-200 py-1 px-4 w-full rounded-full text-sm"
						...
						>
							<svg
								className="w-3 h-3 fill-current text-brand mx-3 shrink-0"
								viewBox="0 0 12 12"
					...
					<p className="text-xs text-secondary mt-1 w-full text-center">
